...
import com.smithware.managermeet.ui.theme.Charcoal
import com.smithware.managermeet.ui.theme.Cream
import com.smithware.managermeet.ui.theme.Graphite
import com.smithware.managermeet.ui.theme.Lime
import com.smithware.managermeet.ui.theme.ManagerMeetTheme
import com.smithware.managermeet.ui.theme.WarmOrange
import kotlinx.coroutines.launch

class MainActivity : ComponentActivity() {
    private val viewModel: ManagerMeetViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val state by viewModel.state.collectAsStateWithLifecycle()
            ManagerMeetTheme(darkTheme = state.darkMode) {
                ManagerMeetApp(state = state, viewModel = viewModel)
            }
        }
    }
}
...
@Composable
private fun ManagerMeetApp(state: ManagerMeetState, viewModel: ManagerMeetViewModel) {
            ...
            CenterAlignedTopAppBar(
                title = {
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text("ManagerMeet", fontWeight = FontWeight.Black)
...
@Composable
private fun DashboardScreen(state: ManagerMeetState, nav: NavHostController, viewModel: ManagerMeetViewModel) {
    LazyColumn(
        ...
        item {
            HeroCard(
                title = "Turn app ideas into build-ready plans.",
                body = "A local product studio dashboard for manager communication, MVP scope, launch readiness, and Codex-ready output.",
        ...
        if (state.projects.isEmpty()) {
            item { EmptyState("No plans yet", "Create the first manager-focused app plan.") { nav.navigate(Route.Add.value) } }
        } else {
...
private fun ProjectFormScreen(
    ...
    viewModel: ManagerMeetViewModel,
...
@Composable
private fun DetailScreen(project: ProjectEntity?, nav: NavHostController, viewModel: ManagerMeetViewModel) {
    if (project == null) {
...
@Composable
private fun ExportScreen(state: ManagerMeetState, nav: NavHostController, snackbar: SnackbarHostState) {
...
@Composable
private fun SettingsScreen(state: ManagerMeetState, viewModel: ManagerMeetViewModel) {
...
@Composable
private fun ProjectRow(project: ProjectEntity, nav: NavHostController, viewModel: ManagerMeetViewModel) {
